...
public class ArrayDeque<T> {
    ...
    public void addToEmptyArray(T i){
        items[2] = i;
        currentFirst = 2;
        currentLast = 2;
        size = 1;
    ...
    public void addFirst(T item){
        ...
        int nextFirst = (currentFirst - 1) % items.length; // useful when currentFirst is already at pos 0, where this will return items.length - 1
    ...
    public void addLast(T item){
        ...
        int nextLast = (currentLast + 1) % items.length; // useful when currentLast is already at end of array, where this will return 0
    ...
    public T removeLast(){
        ...
        currentLast = (currentLast - 1) % items.length;
        size--;
        if (items.length > 128 && size * 4 < items.length){
            contractArraySize();
        }
